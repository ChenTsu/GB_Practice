                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    <?php
                                        $realty_list = $realty_list->get_realty(); // перезаписываем элемент класса результатом функции
                                        ?>
                                        <tr>
                                            <td><?= $realty_list['id'] ?></td>
                                            <td><?= $realty_list['type'] ?></td>
                                            <td><?= $realty_list['address'] ?></td>
                                            <td><?= $realty_list['square'] ?></td>
                                            <td><?= $realty_list['price'] ?></td>
                                            <td><?= $realty_list['additional'] ?></td>
                                            <td><?= $realty_list['agent'] ?></td>
                                            <td><?= $realty_list['description'] ?></td>
                                            <td><?= $realty_list['category'] ?></td>
                                            <td>
                                                <a class="btn btn-primary" href="show.php?id=<?= $realty_list['id'] ?>"><i
                                                        class="fa fa-eye"></i></a>
                                                <a class="btn btn-success" href="edit.php?id=<?= $realty_list['id'] ?>"><i
                                                        class="fa fa-pencil"></i></a>
                                                <a class="btn btn-danger" href="delete.php?id=<?= $realty_list['id'] ?>"><i
