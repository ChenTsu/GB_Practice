        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <hr/>
                    <h3>Управление</h3>
                    <a class="btn btn-success" href="edit.php?id=<?= $realty['id'] ?>"><i class="fa fa-pencil"></i> Редактировать</a>
                    <a class="btn btn-danger" href="delete.php?id=<?= $realty['id'] ?>"><i class="fa fa-times-circle"></i> Удалить</a>
