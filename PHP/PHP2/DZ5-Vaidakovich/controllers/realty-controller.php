...
class  RealtyController
{
    public function add ()
    {
        ...
        if ( isset($_POST['action']) )
        {
            ...
            {
//                $realty = new Realty ();
                if ( $realty = Realty::add( $_POST['object_id'], $_POST['address'], $_POST['square'], $_POST['price'], $_POST['additional'], $_POST['agent'], $_POST['description'], $_POST['category']) )
                {
    ...
    public function edit ()
    {
        ...
        if ( isset($_POST['action']) )
        {
            if ( $_POST['action'] === 'edit' )
            {
                ...
                $realty->set_realty($_POST['object_id'],$_POST['address'], $_POST['square'], $_POST['price'], $_POST['additional'], $_POST['agent'], $_POST['description'], $_POST['category']);
                if ( $realty->update() )
                {
