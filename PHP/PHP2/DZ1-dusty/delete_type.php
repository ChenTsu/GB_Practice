...
if (count($_POST))
{
    ...
    {
        $id = (int) $_POST['id'];
        $query = "DELETE FROM `apartment_types` WHERE `id` = '{$id}' LIMIT 1";
...
<head>
    ...
    <title>Удаление типа недвижимости: <?= $type['title'] ?></title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2>Подтверждаете удаление &laquo;<?= $type['title'] ?>&raquo;?</h2>
